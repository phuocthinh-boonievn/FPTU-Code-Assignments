...
public partial class FUStoreDBContext : DbContext
{
    public FUStoreDBContext()
    {
    }

    public FUStoreDBContext(DbContextOptions<FUStoreDBContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            entity.HasKey(e => new { e.OrderId, e.ProductId })
                .HasName("PK__OrderDet__08D097A39EAF390E");
